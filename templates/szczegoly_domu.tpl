...
<table style="width: 100%; min-height: 200px">
    <tr>
        <td style="border: 1px solid black; text-align: left; vertical-align: top">
            ...
            Powierzchnia domu: {$oferta.pow_domu}<br />
...
<table style="width: 100%">
    <tr>
        ...
        <td style="border: 1px solid black">{if $koszyk}<a href="koszyk.php">Wróć do koszyka >></a>{else}<a href="wyniki_domy.php">Wróć do wyników >></a>{/if}</td>
    </tr>
</table>
<br />
