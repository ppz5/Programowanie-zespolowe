<?php /* Smarty version 2.6.26, created on 2015-02-19 14:09:01
         compiled from szczegoly_mieszkania.tpl */ ?>
<?php echo '
...
<h4>Mieszkanie - szczegóły oferty</h4>
<table cellspacing="0" border="1" style="float: left; width: 400px">
    ...
    <tr>
        ...
        <td><?php echo $this->_tpl_vars['oferta']['pokoje']; ?>
</td>
    </tr>
    <tr>
        <td class="lewa">Metraż:</td>
        <td><?php echo $this->_tpl_vars['oferta']['pow_mieszkania']; ?>
</td>
    </tr>
    <tr>
...
<br />
            Nr lokalu: <?php echo $this->_tpl_vars['oferta']['nr_lokalu']; ?>
<br />
            Cena: <?php echo $this->_tpl_vars['oferta']['cena']; ?>
<br />
            Liczba pokoi: <?php echo $this->_tpl_vars['oferta']['pokoje']; ?>
<br />
            Powierzchnia mieszkania: <?php echo $this->_tpl_vars['oferta']['pow_mieszkania']; ?>
<br />
            Rok budowy: <?php echo $this->_tpl_vars['oferta']['rok']; ?>
<br />
            Piętro: <?php echo $this->_tpl_vars['oferta']['pietro']; ?>
<br />
            Liczba pięter: <?php echo $this->_tpl_vars['oferta']['liczba_pieter']; ?>
<br />
            Winda: <?php if ($this->_tpl_vars['oferta']['winda'] == 't'): ?>jest<?php else: ?>nie ma<?php endif; ?><br />
            Materiał: <?php echo $this->_tpl_vars['oferta']['material']; ?>
<br />
            Stan lokalu: <?php echo $this->_tpl_vars['oferta']['stan_lokalu']; ?>
<br />
            Stan budynku: <?php echo $this->_tpl_vars['oferta']['stan_budynku']; ?>
<br />
            Garaż: <?php if ($this->_tpl_vars['oferta']['garaz'] == 't'): ?>jest<?php else: ?>nie ma<?php endif; ?><br />
            Osiedle: <?php echo $this->_tpl_vars['oferta']['osiedle']; ?>
<br />
...
<table style="width: 100%">
    <tr>
        ...
        <td style="border: 1px solid black"><?php if ($this->_tpl_vars['koszyk']): ?><a href="koszyk.php">Wróć do koszyka >></a><?php else: ?><a href="wyniki_mieszkania.php">Wróć do wyników >></a><?php endif; ?></td>
    </tr>
</table>
<br />
